...
-- Tiempo de generación: 14-05-2019 a las 15:19:03
...
(6, 'Sergio', 'autor3.jpg', 'sergio@sergio.com', 'que bien', '2019-05-02', 3, '::1');
...
CREATE TABLE `usuario` (
  ...
  `tipoUsuario` int(2) NOT NULL DEFAULT '0' COMMENT '0: Registrado | 1: Mod | 2: Gestor | 3: Superuser'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
